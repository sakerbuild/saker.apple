...
@NestInformation("Gets an SDK description for the developer macOS.\n"
		+ "The developer macOS SDK is useful when some values need to be retrieved about the "
		+ "operating system that is used to develop the application.\n"
...
@NestParameterInformation(value = "Version",
		...
		info = @NestInformation("Specifies expected the versions or version ranges of macOS."))
