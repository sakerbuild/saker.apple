...
public class CreateIphoneOsBundleWorkerTaskIdentifier implements TaskIdentifier, Externalizable {
	 ...
	 */
	public CreateIphoneOsBundleWorkerTaskIdentifier() {
	}

	public CreateIphoneOsBundleWorkerTaskIdentifier(SakerPath outputPath) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CreateIphoneOsBundleWorkerTaskIdentifier other = (CreateIphoneOsBundleWorkerTaskIdentifier) obj;
		if (outputPath == null) {
