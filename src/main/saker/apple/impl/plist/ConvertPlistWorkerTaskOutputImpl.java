...
final class ConvertPlistWorkerTaskOutputImpl implements ConvertPlistWorkerTaskOutput, Externalizable {
	 ...
	 */
	public ConvertPlistWorkerTaskOutputImpl() {
	}

	public ConvertPlistWorkerTaskOutputImpl(SakerPath outputPath, String format) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ConvertPlistWorkerTaskOutputImpl other = (ConvertPlistWorkerTaskOutputImpl) obj;
		if (format == null) {
