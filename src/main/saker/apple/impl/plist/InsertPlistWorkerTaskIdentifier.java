...
public class InsertPlistWorkerTaskIdentifier implements TaskIdentifier, Externalizable {
	 ...
	 */
	public InsertPlistWorkerTaskIdentifier() {
	}

	public InsertPlistWorkerTaskIdentifier(SakerPath relativeOutput) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		InsertPlistWorkerTaskIdentifier other = (InsertPlistWorkerTaskIdentifier) obj;
